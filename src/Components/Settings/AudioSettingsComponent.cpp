...
AudioSettingsComponent::AudioSettingsComponent(const sptr<UserSettings> &userSettings, const sptr<AudioDeviceManager> &audioDeviceManager, const sptr<MouseListener> &sharedMouseListener) 
: Component(),
  IModularComponent(audioDeviceManager, sharedMouseListener)
{
  ...
  this->audioDeviceManager->setAudioDeviceSetup(setup, true);
