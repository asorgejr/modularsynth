...
MainComponent::MainComponent(const std::string &name)
  : Component(),
    _settingsView(SettingsComponent(_audioDeviceManager, _mouseListener)),
    _synthKeyboardView(SynthKeyboardComponent(_audioDeviceManager, _mouseListener)),
    _tabComponent(TabbedButtonBar::Orientation::TabsAtTop)
{
