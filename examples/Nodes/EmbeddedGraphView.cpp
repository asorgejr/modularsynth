...
EmbeddedGraphView::EmbeddedGraphView(AudioProcessor *processor) {
  view = std::make_unique<View>(processor);
...
EmbeddedGraphView::View::View(AudioProcessor *processor) : GraphViewComponent(processor) {
